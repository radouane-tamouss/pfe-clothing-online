		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                    ...
                    @else
                         <p style="padding-top:30px;">Aucun Produits trouver</p>
                    @endif
					...
					<div class="widget mercado-widget filter-widget">
						...
						<div class="widget-content">
							...
							<div class="widget-banner">
								...
								<model-viewer src="{{ asset('assets/3d/glasses/scene.gltf')}}" alt="air force" auto-rotate camera-controls ar ios-src="assets/3d/glasses/scene.gltf"  class="banner-figure">
            					</model-viewer>
							</div>
						</div>
					</div><!-- Size -->
