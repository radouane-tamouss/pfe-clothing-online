...
<body>
    ...
    <table style="width: 600px; text-align:right">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="3"></td>
                <td  style="font-size:15px;font-weight:bold;">prix HT : {{$order->subtotal}} MAD</td>
            </tr>
            <tr>
                <td colspan="3"></td>
                <td  style="font-size:15px;font-weight:bold;">TVA : {{$order->tax}} MAD</td>
            </tr>
            ...
            <tr>
                <td colspan="3"></td>
                <td style="font-size:15px;font-weight:bold;">Total : {{$order->total}} MAD</td>
            </tr>
        </tbody>
    </table>    
</body>
